...
@php
    $game_number = 2;
    $unit_number = 6;
    $unit_title = 'Unit 6: What happens in the garden?';

    // Dữ liệu cho game Order. $items chỉ dùng để render, $correctOrder dùng cho logic JS.
    $items = [
        ['name' => 'dig', 'image_file' => 'dig.jpg'],
        ['name' => 'eat', 'image_file' => 'eat.jpg'],
        ['name' => 'pick', 'image_file' => 'pick.jpg'],
        ['name' => 'water', 'image_file' => 'water.jpg'],
        ['name' => 'wash', 'image_file' => 'wash.jpg'],
        ['name' => 'plant', 'image_file' => 'plant.jpg'],
    ];

    // Dãy đáp án đúng theo thứ tự trong file audio script
    $correctOrder = ['dig', 'eat', 'pick', 'plant', 'wash', 'water'];
    $audio_file_name = 'sat_level02_game06.mp3';
...
@section('content')
    ...
    <main class="game-content">
        <div class="top-bar">
            ...
            {{-- Navigation: Unit trước (Unit 5) và Unit tiếp theo (Unit 7) --}}
