...
@php
    $game_number = 2;
    $unit_number = 3;
    $unit_title = 'Unit 3: Who makes you happy?';

    // Dữ liệu cho các mục cần match: [answer] là tên từ, [file] là tên file.
    $items = [
        ['answer' => 'hungry', 'file' => 'hungry.mp3', 'image_file' => 'hungry.jpg'],
        ['answer' => 'happy', 'file' => 'happy.mp3', 'image_file' => 'happy.jpg'],
        ['answer' => 'tired', 'file' => 'tired.mp3', 'image_file' => 'tired.jpg'],
        ['answer' => 'sad', 'file' => 'sad.mp3', 'image_file' => 'sad.jpg'],
        ['answer' => 'thirsty', 'file' => 'thirsty.mp3', 'image_file' => 'thirsty.jpg'],
        ['answer' => 'lively', 'file' => 'lively.mp3', 'image_file' => 'lively.jpg'],
    ];
...
@push('styles')
    {{-- CSS riêng cho Unit 3 của Game 2 --}}
...
@section('content')
    ...
    <main class="game-content">
        <div class="top-bar">
            ...
            {{-- Navigation: Unit trước (Unit 2) và Unit tiếp theo (Unit 4) --}}
        ...
        <div class="lesson-box">
            ...
            {{-- Nút âm thanh (Đã cập nhật đường dẫn) --}}
            <div class="audio-buttons">
                @foreach ($items as $item)
                    <button class="audio" data-answer="{{ $item['answer'] }}" {{-- **Đường dẫn audio đã được sửa để sử dụng /images/.../unit3/sound/** --}}
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            // Lấy danh sách đáp án từ dữ liệu PHP/Blade (hungry, happy, tired, sad, thirsty, lively)
