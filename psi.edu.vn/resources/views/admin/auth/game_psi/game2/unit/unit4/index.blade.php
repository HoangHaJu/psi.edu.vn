...
@php
    $game_number = 2;
    $unit_number = 4;
    $unit_title = 'Unit 4: What happens when it’s windy?';

    // Dữ liệu cho game Order. $items chỉ dùng để render, $correctOrder dùng cho logic JS.
    $items = [
        ['name' => 'cold', 'image_file' => 'cold.jpg'],
        ['name' => 'hot', 'image_file' => 'hot.jpg'],
        ['name' => 'snowy', 'image_file' => 'snowy.jpg'],
        ['name' => 'rainy', 'image_file' => 'rainy.jpg'],
        ['name' => 'windy', 'image_file' => 'windy.jpg'],
        ['name' => 'sunny', 'image_file' => 'sunny.jpg'],
    ];

    // Dãy đáp án đúng theo thứ tự trong file audio script
    $correctOrder = ['cold', 'hot', 'rainy', 'snowy', 'sunny', 'windy'];
    $audio_file_name = 'sat_level02_game04.mp3';
...
@push('styles')
    {{-- CSS riêng cho Unit 4 của Game 2 --}}
...
@section('content')
    ...
    <main class="game-content">
        <div class="top-bar">
            ...
            {{-- Navigation: Unit trước (Unit 3) và Unit tiếp theo (Unit 5) --}}
        ...
        <div class="lesson-box">
            ...
            {{-- Audio tổng hợp (Đã cập nhật đường dẫn) --}}
