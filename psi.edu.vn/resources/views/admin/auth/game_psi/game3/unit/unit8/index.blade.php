...
@php
    $game_number = 3;
    $unit_number = 8;
    $unit_title = 'Unit 8: How do we make music?';

    // Dữ liệu cho game Match: [answer] là tên từ, [file] là tên file audio.
    $items = [
        ['answer' => 'guitar', 'file' => 'guitar.mp3'],
        ['answer' => 'piano', 'file' => 'piano.mp3'],
        ['answer' => 'drums', 'file' => 'drums.mp3'],
        ['answer' => 'shaker', 'file' => 'shaker.mp3'],
        ['answer' => 'tambourine', 'file' => 'tambourine.mp3'],
        ['answer' => 'flute', 'file' => 'flute.mp3'],
    ];
...
@section('content')
    ...
    <main class="game-content">
        <div class="top-bar">
            ...
            {{-- Navigation: Unit tiếp theo (Unit 9) --}}
            <a href="{{ route('admin.game_psi.unit.show', ['game' => $game_number, 'unit' => $unit_number + 1]) }}">
        ...
        <div class="lesson-box">
            ...
            <div class="audio-buttons">
                @foreach ($items as $item)
                    {{-- Chỉ có icon loa --}}
                    <button class="audio" data-answer="{{ $item['answer'] }}" {{-- Đường dẫn audio: /admin/assets/images/game3/unit8/sound/{file} --}}
            ...
            <div class="characters">
                ...
                <div class="character" data-name="drums">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/drums.jpg") }}"
                        alt="drums" />
                </div>
                <div class="character" data-name="flute">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/flute.jpg") }}"
                        alt="flute" />
                </div>
                <div class="character" data-name="guitar">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/guitar.jpg") }}"
                        alt="guitar" />
                </div>
                <div class="character" data-name="piano">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/piano.jpg") }}"
                        alt="piano" />
                </div>
                <div class="character" data-name="shaker">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/shaker.jpg") }}"
                        alt="shaker" />
                </div>
                <div class="character" data-name="tambourine">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/tambourine.jpg") }}"
                        alt="tambourine" />
                </div>
            </div>
