...
@php
    $game_number = 3;
    $unit_number = 7;
    $unit_title = 'Unit 7: What jobs do people do?';

    // Dữ liệu cho game Match: [answer] là tên từ, [file] là tên file audio.
    // Lưu ý: data-answer được giữ nguyên để khớp với data-name của hình ảnh.
    $items = [
        ['answer' => 'vet', 'display' => 'vet', 'file' => 'vet.mp3'],
        ['answer' => 'chef', 'display' => 'chef', 'file' => 'chef.mp3'],
        ['answer' => 'firefighter', 'display' => 'firefighter', 'file' => 'firefighter.mp3'],
        ['answer' => 'nurse', 'display' => 'nurse', 'file' => 'nurse.mp3'],
        ['answer' => 'taxi_driver', 'display' => 'taxi driver', 'file' => 'taxi_driver.mp3'], // Có dấu gạch dưới trong answer
        ['answer' => 'police_officer', 'display' => 'police officer', 'file' => 'police_officer.mp3'], // Có dấu gạch dưới trong answer
    ];
...
@section('content')
    ...
    <main class="game-content">
        <div class="top-bar">
            ...
            {{-- Navigation: Unit tiếp theo (Unit 8) --}}
            <a href="{{ route('admin.game_psi.unit.show', ['game' => $game_number, 'unit' => $unit_number + 1]) }}">
        ...
        <div class="lesson-box">
            ...
            <div class="audio-buttons">
                @foreach ($items as $item)
                    {{-- Dùng 'display' cho nội dung hiển thị --}}
                    <button class="audio" data-answer="{{ $item['answer'] }}" {{-- Đường dẫn audio: /admin/assets/images/game3/unit7/sound/{file} --}}
            ...
            <div class="characters">
                ...
                <div class="character" data-name="firefighter">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/firefighter.jpg") }}"
                        alt="firefighter" />
                </div>
                <div class="character" data-name="chef">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/chef.jpg") }}"
                        alt="chef" />
                </div>
                <div class="character" data-name="police_officer">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/police_officer.jpg") }}"
                        alt="police officer" />
                </div>
                <div class="character" data-name="taxi_driver">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/taxi_driver.jpg") }}"
                        alt="taxi driver" />
                </div>
                <div class="character" data-name="vet">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/vet.jpg") }}"
                        alt="vet" />
                </div>
                <div class="character" data-name="nurse">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/nurse.jpg") }}"
                        alt="nurse" />
                </div>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            characterImages.forEach(character => {
                character.addEventListener('click', () => {
                    ...
                    // So sánh: chuyển tất cả về chữ thường.
