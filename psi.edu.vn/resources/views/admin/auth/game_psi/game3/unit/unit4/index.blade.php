...
@php
    $game_number = 3;
    $unit_number = 4;
    $unit_title = "Unit 4: What's in your neighborhood?";
    ...
    $items = [
        ['answer' => 'library', 'file' => 'library.mp3', 'image_file' => 'library.jpg'],
        ['answer' => 'park', 'file' => 'park.mp3', 'image_file' => 'park.jpg'],
        ['answer' => 'coffee_shop', 'file' => 'coffee_shop.mp3', 'image_file' => 'coffee_shop.jpg'],
        ['answer' => 'zoo', 'file' => 'zoo.mp3', 'image_file' => 'zoo.jpg'],
        ['answer' => 'swimming_pool', 'file' => 'swimming_pool.mp3', 'image_file' => 'swimming_pool.jpg'],
        ['answer' => 'supermarket', 'file' => 'supermarket.mp3', 'image_file' => 'supermarket.jpg'],
    ];
...
@section('content')
    ...
    <main class="game-content">
        <div class="top-bar">
            ...
            {{-- Navigation: Unit tiếp theo (Unit 5) --}}
            <a href="{{ route('admin.game_psi.unit.show', ['game' => $game_number, 'unit' => $unit_number + 1]) }}">
        ...
        <div class="lesson-box">
            ...
            <div class="audio-buttons">
                @foreach ($items as $index => $item)
                    {{-- Chỉ có icon loa, không có text --}}
                    <button class="audio" data-answer="{{ $item['answer'] }}" {{-- Đường dẫn audio: /admin/assets/images/game3/unit4/sound/{file} --}}
            ...
            <div class="characters">
                <div class="character" data-name="coffee_shop">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/coffee_shop.jpg") }}"
                        alt="coffee_shop" />
                </div>
                <div class="character" data-name="library">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/library.jpg") }}"
                        alt="library" />
                </div>
                <div class="character" data-name="park">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/park.jpg") }}"
                        alt="park" />
                </div>
                <div class="character" data-name="supermarket">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/supermarket.jpg") }}"
                        alt="supermarket" />
                </div>
                <div class="character" data-name="swimming_pool">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/swimming_pool.jpg") }}"
                        alt="swimming_pool" />
                </div>
                <div class="character" data-name="zoo">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/zoo.jpg") }}"
                        alt="zoo" />
                </div>
            </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Lưu ý: Javascript sử dụng các giá trị từ PHP Blade (được tạo ở trên)
