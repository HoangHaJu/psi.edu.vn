...
@php
    $game_number = 3;
    $unit_number = 1;
    $unit_title = "Unit 1: What's your school like?";

    // Dữ liệu cho game Match: [answer] là tên từ, [file] là tên file audio, [image_file] là tên file ảnh.
    $items = [
        ['answer' => 'ceiling', 'file' => 'ceiling.mp3', 'image_file' => 'ceiling.jpg'],
        ['answer' => 'door', 'file' => 'door.mp3', 'image_file' => 'door.jpg'],
        ['answer' => 'floor', 'file' => 'floor.mp3', 'image_file' => 'floor.jpg'],
        ['answer' => 'light', 'file' => 'light.mp3', 'image_file' => 'light.jpg'],
        ['answer' => 'sink', 'file' => 'sink.mp3', 'image_file' => 'sink.jpg'],
        ['answer' => 'window', 'file' => 'window.mp3', 'image_file' => 'window.jpg'],
    ];
...
@push('styles')
    ...
    <style>
        ...
        .audio strong.p {
            font-size: 1.2em;
            /* Tăng kích thước chữ cho dễ nhìn */
            font-weight: bold;
        }
    </style>
@endpush
...
@section('content')
    ...
    <main class="game-content">
        <div class="top-bar">
            ...
            {{-- Navigation: Unit trước (Unit 1 là unit đầu nên trỏ về chính nó) --}}
            ...
            {{-- Navigation: Unit tiếp theo (Unit 2) --}}
        ...
        <div class="lesson-box">
            ...
            <div class="audio-buttons">
                @foreach ($items as $item)
                    <button class="audio" data-answer="{{ $item['answer'] }}" {{-- Đường dẫn audio: /admin/assets/images/game3/unit1/sound/{file} --}}
