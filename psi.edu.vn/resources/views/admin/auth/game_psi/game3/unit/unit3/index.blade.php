...
@php
    $game_number = 3;
    $unit_number = 3;
    $unit_title = 'Unit 3: What happens on your birthday?';

    // Dữ liệu cho game Match: [answer] là tên từ, [file] là tên file audio, [image_file] là tên file ảnh.
    $items = [
        ['answer' => 'birthday_cake', 'file' => 'birthday_cake.mp3', 'image_file' => 'birthday_cake.jpg'],
        ['answer' => 'candle', 'file' => 'candle.mp3', 'image_file' => 'candle.jpg'],
        ['answer' => 'card', 'file' => 'card.mp3', 'image_file' => 'card.jpg'],
        ['answer' => 'game', 'file' => 'game.mp3', 'image_file' => 'game.jpg'],
        ['answer' => 'mask', 'file' => 'mask.mp3', 'image_file' => 'mask.jpg'],
        ['answer' => 'present', 'file' => 'present.mp3', 'image_file' => 'present.jpg'],
    ];
...
@section('content')
    ...
    <main class="game-content">
        <div class="top-bar">
            ...
            {{-- Navigation: Unit tiếp theo (Unit 4) --}}
            <a href="{{ route('admin.game_psi.unit.show', ['game' => $game_number, 'unit' => $unit_number + 1]) }}">
        ...
        <div class="lesson-box">
            ...
            <div class="audio-buttons">
                @foreach ($items as $item)
                    <button class="audio" data-answer="{{ $item['answer'] }}" {{-- Đường dẫn audio: /admin/assets/images/game3/unit3/sound/{file} --}}
                        data-sound="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/sound/{$item['file']}") }}">
                        <strong class="p">{{ str_replace('_', ' ', $item['answer']) }}</strong>
                    </button>
                @endforeach
            </div>
            ...
            <div class="characters">
                <div class="character" data-name="candle">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/candle.jpg") }}"
                        alt="candle" />
                </div>
                <div class="character" data-name="birthday_cake">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/birthday_cake.jpg") }}"
                        alt="birthday_cake" />
                </div>
                <div class="character" data-name="mask">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/mask.jpg") }}"
                        alt="mask" />
                </div>
                <div class="character" data-name="game">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/game.jpg") }}"
                        alt="game" />
                </div>
                <div class="character" data-name="card">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/card.jpg") }}"
                        alt="card" />
                </div>
                <div class="character" data-name="present">
                    <img src="{{ asset("admin/assets/images/game_psi/game{$game_number}/unit{$unit_number}/img/present.jpg") }}"
                        alt="present" />
                </div>
            </div>
