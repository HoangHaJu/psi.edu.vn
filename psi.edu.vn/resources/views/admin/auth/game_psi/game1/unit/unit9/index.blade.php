...
@section('title', 'Game 1 - Unit 9: What snacks do you like?')
...
@section('content')
    ...
    <main class="game-content">
        <div class="top-bar">
            ...
            <a href="#" class="btn nav disabled"><span class="arrow">&raquo;</span></a>
        </div>
        ...
        <div class="lesson-box">
            <div class="lesson-header">
                <img src="{{ asset('admin/assets/images/game_psi/image_general/Frame69.png') }}" class="touch-icon"
                    alt="touch icon">
                <h2>Unit 9: What snacks do you like?</h2>
            </div>
            ...
            <div class="audio-buttons">
                @php
                    $audioData = [
                        ['answer' => 'apple', 'file' => 'apple.mp3'],
                        ['answer' => 'banana', 'file' => 'banana.mp3'],
                        ['answer' => 'grape', 'file' => 'grape.mp3'],
                        ['answer' => 'strawberry', 'file' => 'strawberry.mp3'],
                    ];
                @endphp

                @foreach ($audioData as $audio)
                    <button class="audio" data-answer="{{ $audio['answer'] }}"
                        data-sound="{{ asset("admin/assets/images/game_psi/game1/unit9/sound/{$audio['file']}") }}">
            ...
            <div class="characters">
                @foreach (['apple', 'banana', 'grape', 'strawberry'] as $character)
                    <div class="character" data-name="{{ $character }}">
                        <img src="{{ asset("admin/assets/images/game_psi/game1/unit9/img/{$character}.jpg") }}"
                            alt="{{ $character }}">
                    </div>
                @endforeach
            </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const answers = ["apple", "banana", "grape", "strawberry"];
