...
@section('title', 'Game 1 - Unit 3: How many eyes?')
...
@push('styles')
    ...
    <style>
        ...
        .audio-buttons button.audio img {
            pointer-events: none;
        }
    </style>
@endpush
...
@section('content')
    ...
    <main class="game-content">
        <div class="top-bar">
            ...
            <a href="{{ route('admin.game_psi.unit.show', ['game' => 1, 'unit' => 4]) }}" class="btn nav"><span
        ...
        <div class="lesson-box">
            ...
            <div class="audio-buttons">
                @php
                    $audioData = [
                        ['answer' => 'mouth', 'file' => 'mouth.mp3'],
                        ['answer' => 'ears', 'file' => 'ears.mp3'],
                        ['answer' => 'eyes', 'file' => 'eyes.mp3'],
                        ['answer' => 'nose', 'file' => 'nose.mp3'],
                    ];
                @endphp

                @foreach ($audioData as $audio)
                    <button class="audio" data-answer="{{ $audio['answer'] }}"
                        data-sound="{{ asset("admin/assets/images/game_psi/game1/unit3/sound/{$audio['file']}") }}">
            ...
            <div class="characters">
                @foreach (['ears', 'eyes', 'mouth', 'nose'] as $character)
                    <div class="character" data-name="{{ $character }}">
                        <img src="{{ asset("admin/assets/images/game_psi/game1/unit3/img/{$character}.jpg") }}"
                            alt="{{ $character }}">
                    </div>
                @endforeach
            </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const answers = ["mouth", "ears", "eyes", "nose"];
