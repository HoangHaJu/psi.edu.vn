...
@section('title', 'Game 1 - Unit 5: What can you find outside?')
        ...
        <div class="lesson-box">
            <div class="lesson-header">
                <img src="{{ asset('admin/assets/images/game_psi/image_general/Frame69.png') }}" class="touch-icon"
                    alt="touch icon">
                <h2>Unit 5: What can you find outside?</h2>
            </div>
            ...
            <div class="audio-buttons">
                @php
                    $audioData = [
                        ['answer' => 'tree', 'file' => 'tree.mp3'],
                        ['answer' => 'flower', 'file' => 'flower.mp3'],
                        ['answer' => 'lake', 'file' => 'lake.mp3'],
                        ['answer' => 'hill', 'file' => 'hill.mp3'],
                    ];
                @endphp

                @foreach ($audioData as $audio)
                    <button class="audio" data-answer="{{ $audio['answer'] }}"
                        data-sound="{{ asset("admin/assets/images/game_psi/game1/unit5/sound/{$audio['file']}") }}">
            ...
            <div class="characters">
                @foreach (['tree', 'flower', 'hill', 'lake'] as $character)
                    <div class="character" data-name="{{ $character }}">
                        <img src="{{ asset("admin/assets/images/game_psi/game1/unit5/img/{$character}.jpg") }}"
                            alt="{{ $character }}">
                    </div>
                @endforeach
            </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const answers = ["tree", "flower", "lake", "hill"];
