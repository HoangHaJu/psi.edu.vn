<div class="col-12 col-md-9">
    <div class="card">
        ...
        <div class="card-body row">
            ...
            <x-input type="hidden" name="date" :value="old('date')" />
            <div class="col-md-6 mb-3">
                <label class="control-label"><i class="ti ti-calendar-range"></i> {{ __('Khoảng ngày học') }}:</label>
                <x-input type="text" name="daterange" id="daterange" :value="old('daterange')" :required="true" />
            </div>
