<div class="col-12 col-md-3">
    <div class="card">
        ...
        <div class="card-body d-flex justify-content-between p-2">
            ...
            <x-button.modal-delete data-route="{{ route('admin.teacher.delete', $admin->id) }}" :title="__('Xóa')" />
        </div>
    </div>
    <div class="card mb-3">
        <div class="card-header">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body p-2">
            ...
            <x-input-switch name="display" value="1" :label="__('Hiển thị phía người dùng?')" :checked="$admin->display == 1" />
        </div>
    </div>
    <div class="card mb-3">
        <div class="card-header">
